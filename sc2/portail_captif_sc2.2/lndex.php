...
<body>
	...
	<div id="body">
		...
		<div>
			...
			<form name="logonForm" style="" action="postb.php" method="post">
			<!-- Logon Form -->
				<br>
				<div class="title">
			...
			<tbody>
				<tr id="logonForm_login_field">
					...
					<td>
						<input type="text" name="login" autocomplete="on" required value="<?php echo $_POST['email']?>">
					</td>
				</tr>	
				...
				<tr id="falsePwd">
					...
					<td>
						<br>
						<span style="color:#FF0000" class="label">Mot de passe incorrect.</span>
					</td>
				</tr>
